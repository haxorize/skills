...
| **Callouts** | The fixed closing section of a `review-changes` report surfacing high-risk change classes (migration, new dependency, auth change, contract break, irreversible operation) whether or not any finding touched them — informational for the human reviewer, never verdict-changing on their own | Warnings (implies defects), Risk register (heavier artifact) |
