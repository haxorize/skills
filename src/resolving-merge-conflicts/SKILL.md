...
- **Where the intents are genuinely incompatible**, pick the one matching the **merge's stated goal** (the feature being merged, the branch you're rebasing onto) and note the trade-off.
