...
A comment or issue an agent posts to a tracker under its own identity opens with one line saying it was AI-generated: the gate above decides whether the post happens, this decides what it discloses. A message drafted *as* the user is `writing-for-humans`' outbound convention, not this.
