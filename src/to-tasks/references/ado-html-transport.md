...
```bash
python3 -c "import sys, markdown; print(markdown.markdown(sys.stdin.read()))" < body.md > body.html
```
...
- `$TAGS` is the derived tag set — see [work-item-tags.md](work-item-tags.md) for derivation and when to omit the pair.
