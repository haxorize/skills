...
- [ ] Every relocation to a reference names the condition under which a run opens it; a condition of "always" keeps the content inline or cuts it, never discloses it
