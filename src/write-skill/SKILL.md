...
The rows live in [references/review-checklist.md](references/review-checklist.md), opened by the close-out step in § Workflow and by every skill-change review, which reports conformance against them row by row.
