...
2. **GREEN**: Write minimal code to pass. Run the test command — confirm it passes. Passing means making the *requested* behavior true — never a narrower, safer, easier-to-test substitute; redefining success around what already passes is the failure, not a strategy.
