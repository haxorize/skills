...
2. Run the suite (and the build, where the language needs a compile) via the `/feedback-loops` skill — if you don't see a `Launching skill: feedback-loops` line, load it first.
