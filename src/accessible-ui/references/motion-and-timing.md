...
Open this only when the change adds or alters animation, a transition, auto-advancing content, a flashing element, a timeout, or a self-dismissing toast. The body's rule stands: non-essential motion gates on the person's setting, and nothing auto-advances or times out without a way to stop it.
