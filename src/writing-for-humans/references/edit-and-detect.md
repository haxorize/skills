# The two modes, and the preservation contract

Read this only when the text in hand was already written — someone else's prose, or an earlier run's draft; a first draft from nothing reaches neither mode and has no source to preserve.
