...
| **Session summary, incident report** | Outcome first, simple past with times, the unknown stated as "unknown"; the tense and first-and-last-line rules in [references/register-by-artifact.md](references/register-by-artifact.md) — open it before writing one |
| **On-call shift note (the outgoing on-call, per shift)** | Five sections, each present or an explicit "none", named in [references/register-by-artifact.md](references/register-by-artifact.md) — open it before writing one |
...
| **Commit message, PR body, review reply, closing comment** | A maintainer recording a decision for another maintainer, impersonal and matter-of-fact; the person and mood rules, and the catalog family that fires here, in [references/register-by-artifact.md](references/register-by-artifact.md) — open it before writing one |
| **Meeting notes (whoever posts the recap)** | Decided separated from discussed, actions owned and dated or flagged; the verbatim rule in [references/register-by-artifact.md](references/register-by-artifact.md), and a recap drawn from a transcript or recording reads it under [references/recap-from-transcript.md](references/recap-from-transcript.md) — open them before writing one |
| **Weekly status note to a manager (any engineer, weekly)** | Progress, not activity; opens with what last week's note said would happen and whether it did; the status line and four sections in [references/register-by-artifact.md](references/register-by-artifact.md), opened before writing one |
| **Runbook, release or migration procedure (its owning engineer, per change)** | From a real run, one action per step — the skeleton in [references/register-by-artifact.md](references/register-by-artifact.md) — open it before writing one |
