...
**The dash sweep** is stated at the top of this body and owned by `~/.claude/rules/outbound-dash-sweep.md`; the pipeline it runs is in [references/outbound-as-the-user.md](references/outbound-as-the-user.md) § The dash sweep.
