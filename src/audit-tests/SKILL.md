---
name: audit-tests
description: Audit an existing test suite by asking "can these checks fail?" — grade load-bearing assertions CONFIRMED, PLAUSIBLE, CANNOT FAIL, CHANGE DETECTOR, or BLIND, and name what the suite cannot catch even when green.
